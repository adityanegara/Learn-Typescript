...
const _9_DnDCharacter_1 = require("../src/9.DnDCharacter");
describe('Ability generator', () => {
    it('Random ability is within range', () => {
        const abilityScore = _9_DnDCharacter_1.DnDCharacter.generateAbilityScore();
...
describe('Ability modifier', () => {
    it('Ability modifier for score 3 is -4', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(3)).toEqual(-4);
    });
    it('Ability modifier for score 4 is -3', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(4)).toEqual(-3);
    });
    it('Ability modifier for score 5 is -3', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(5)).toEqual(-3);
    });
    it('Ability modifier for score 6 is -2', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(6)).toEqual(-2);
    });
    it('Ability modifier for score 7 is -2', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(7)).toEqual(-2);
    });
    it('Ability modifier for score 8 is -1', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(8)).toEqual(-1);
    });
    it('Ability modifier for score 9 is -1', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(9)).toEqual(-1);
    });
    it('Ability modifier for score 10 is 0', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(10)).toEqual(0);
    });
    it('Ability modifier for score 11 is 0', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(11)).toEqual(0);
    });
    it('Ability modifier for score 12 is 1', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(12)).toEqual(1);
    });
    it('Ability modifier for score 13 is 1', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(13)).toEqual(1);
    });
    it('Ability modifier for score 14 is 2', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(14)).toEqual(2);
    });
    it('Ability modifier for score 15 is 2', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(15)).toEqual(2);
    });
    it('Ability modifier for score 16 is 3', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(16)).toEqual(3);
    });
    it('Ability modifier for score 17 is 3', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(17)).toEqual(3);
    });
    it('Ability modifier for score 18 is 4', () => {
        expect(_9_DnDCharacter_1.DnDCharacter.getModifierFor(18)).toEqual(4);
    });
});
describe('Character creation', () => {
    it('Random character is valid', () => {
        const character = new _9_DnDCharacter_1.DnDCharacter();
        expect(character.hitpoints).toEqual(10 + _9_DnDCharacter_1.DnDCharacter.getModifierFor(character.constitution));
